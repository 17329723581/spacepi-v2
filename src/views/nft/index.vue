<template>
    <div class="nft">
        <div class="nft-container">
            ...
            <!-- NFT主体 -->
            <div class="nft-subject wow spacepi-animation fade-in-up-animation" v-for="(item, index) in getNftTypeData"
                :key="index">
                ...
                <div class="nft-img-container">
                    <div class="nft-img" v-for="(i, indexs) in getNftListData" :key="indexs" v-if="i.t_id == item.id"
                        @click="spacepiTo(i.url)">
...
@media screen and (max-width:600px) {
    ...
    .nft-container {
        ...
        .nft-subject {
            ...
            .nft-img-container::-webkit-scrollbar {
                //隐藏滚动条
                display: none;
            }
        }
