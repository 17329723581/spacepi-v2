const locale = {
	...
	spacepiwep:{
		...
		o:"On board",
		bnt:"審計報告",
		text:"基於此觀點，SpacePi 已成為其生態系統內購買虛擬資產或服務的投資工具，將隨著 SpacePi 的應用而迸發出新的活力和前所未有的價值。 以下是 SpacePi 生態系統的一些關鍵點。",
		trend_bnt_title:"SpacePi 趨勢",
		trend_bnt_url:"https://www.baidu.com/?tn=44004473_35_oem_dg",
	},
	// partners轮播内容
	partners_carousel_text:"SPACEPI 將永遠是 PI NETWORK 的忠實粉絲！SPACEPI 現在所做的一切都是為了證明 PI 粉絲的堅持是值得的！",
	// 选择语言
	selectLang: "選擇語言",
